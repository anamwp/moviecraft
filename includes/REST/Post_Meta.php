 ...
 *
 * @since 1.0.0
 * @package MovieCraft\REST
 */

namespace MovieCraft\REST;
...
class Post_Meta
{
	...
	{
		add_action('rest_api_init', array($this, 'moviecraft_register_rest_route_callback'));
	}
	/**
	 * Register rest routes.
	 */
	public function moviecraft_register_rest_route_callback()
	{
		/**
		 * Add meta route.
		 */
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array($this, 'moviecrafthandle_add_block_meta_callback'),
				'args'                => array(
					'post_id' => array(
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array($this, 'moviecrafthandle_remove_block_meta_callback'),
				'args'                => array(
					'post_id' => array(
						'validate_callback' => function ($param) {
							return is_numeric($param);
