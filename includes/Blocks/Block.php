...
class Block
{
	...
	public function register_block()
	{
		 ...
		 */
		// register_block_type_from_metadata(MOVIE_CRAFT_STARTER_PATH . '/build/blocks/card');
		// register_block_type_from_metadata(MOVIE_CRAFT_STARTER_PATH . '/build/blocks/call-to-action');
		// register_block_type_from_metadata(MOVIE_CRAFT_STARTER_PATH . '/build/blocks/blurb');
		// Post
		// register_block_type_from_metadata(MOVIE_CRAFT_STARTER_PATH . '/build/blocks/single-post');
		// register_block_type_from_metadata(MOVIE_CRAFT_STARTER_PATH . '/build/blocks/category-post');
		// register_block_type_from_metadata(MOVIE_CRAFT_STARTER_PATH . '/build/blocks/smart-category-posts');
		// register_block_type_from_metadata(MOVIE_CRAFT_STARTER_PATH . '/build/blocks/post-lists-tab');
		// WooCommerce
		// register_block_type_from_metadata(MOVIE_CRAFT_STARTER_PATH . '/build/blocks/recent-product');
		// register_block_type_from_metadata(MOVIE_CRAFT_STARTER_PATH . '/build/blocks/sale-product');
		// register_block_type_from_metadata(MOVIE_CRAFT_STARTER_PATH . '/build/blocks/featured-product');
		// register_block_type_from_metadata(MOVIE_CRAFT_STARTER_PATH . '/build/blocks/popular-product');
		// register_block_type_from_metadata(MOVIE_CRAFT_STARTER_PATH . '/build/blocks/category-product');
		// Movies and API
	...
	{
		// $asset_file = require(MOVIE_CRAFT_STARTER_DIR_URL . 'build/index.asset.php');
		// $asset_file = include MOVIE_CRAFT_STARTER_PATH . '/build/index.asset.php';
		/**
		 * register block script
		 */
		// wp_register_script(
		// 'starter-script',
		// MOVIE_CRAFT_STARTER_DIR_URL . 'build/index.js',
		...
		// MOVIE_CRAFT_STARTER_DIR_URL . 'build/index.css',
		// array(),
		// $asset_file['version']
		// );
		/**
		...
		// MOVIE_CRAFT_STARTER_DIR_URL . 'build/style-index.css',
		// array(),
		// $asset_file['version']
		// );
