...
class Product_Tab
{
	...
	public function __construct()
	{
		 ...
		 */
		add_filter('woocommerce_product_data_tabs', array($this, 'moviecraftproduct_tab__meta_information_callback'), 10, 1);
		/**
		 * Add fields for [meta information] custom tab
		 */
		add_action('woocommerce_product_data_panels', array($this, 'moviecraftproduct_tab_panel__meta_information_callback'));
		/**
		 * Add [Shipping Information] extra text field to shipping tab
		 */
		add_action('woocommerce_product_options_shipping_product_data', array($this, 'moviecraftadd_extra_text_field_to_shipping_tab_callback'));
		/**
		 * Add [Return policy] extra text field to general tab
		 */
		add_action('woocommerce_product_options_general_product_data', array($this, 'moviecraftadd_extra_text_field_to_general_tab_callback'));
	}
	/**
